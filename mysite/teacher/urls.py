...
urlpatterns =[
    ...
    path('record/<int:record_id>/edit_unapproved/', views.change_status_unapproved, name='change_status_unapproved'),
    path('form/<int:id>/edit/', views.change_status2, name='change_status2'),
    path('teacher/form/<int:create_form>/edit_unapproved2/', views.change_status_unapproved2, name='edit_unapproved2'),
    path('teacher/after/<int:after>/edit_unapproved3/', views.change_status_unapproved3, name='edit_unapproved3'),
